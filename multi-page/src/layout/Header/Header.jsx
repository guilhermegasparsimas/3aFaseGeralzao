            ...
            <div>
                {
                    user ? (
                        <>
                            ...
                            <button onClick={handleLogout} className='bg-red-500 text-white px-3 py-1 rounded hover:bg-red-700 cursor-pointer'> Logout </button>
                        </>
                    ) : (
                        <NavLink to="/login" className="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700">
                            Login 
                        </NavLink>
                    )
                }
