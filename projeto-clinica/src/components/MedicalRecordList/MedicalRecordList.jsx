...
import { prismaClient } from "../../../../clinic_api_alterado/prisma/prisma";
...
const MedicalRecordListPage = () => {
    ...
    const fetchPatients = async () => {
        try {
            ...
            console.error(" error ao obter os dados dos prontuários", error)
        }
    }
    ...
    const filteredPatients = patients.filter((patient) => {
        return (
            patient.fullName.toLowerCase().includes(searchTerm.toLowerCase()) || patient.id.toString().includes(searchTerm)
        )
    })
