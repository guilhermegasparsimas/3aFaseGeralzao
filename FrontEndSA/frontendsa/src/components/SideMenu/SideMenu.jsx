...
const SideMenu = () => {
    ...
    return (
        <aside
            className={`h-screen bg-cyan-800 text-white flex flex-col justify-between transition-all duration-300 cursor ${isCollapsed ? "w-20" : "w-64"
                }`}
        >
            ...
            <div className="p-4 flex items-center justify-between border-2 border-cyan-700">
                {
                    !isCollapsed && (
                        <h1 className="text-lg font-bold">Front End Sa</h1>
                    )
                }
                <button
                    onClick={toggleMenu}
            ...
            {/* Menu */}
            <nav className="flex-1 p-4 space-4 overflow-y-auto">
                <ul className="space-y-3">
                    ...
                    {!isCollapsed && 
                        <h2 className="text-white py-4 font-bold text-lg">Prontuários</h2>
                    }
